...
#   Example PIAIC71231_Assignment1.py
...
def function2():
    ...
    x = np.arange(10,37).reshape((3,3,3))     #wrtie your code here
...
def function8():
    ...
    x = np.arange(4, dtype=float)    #wrtie your code here
    x
    np.zeros_like(x)
...
def function9():
    ...
    a = np.arange(0,102,2)     #wrtie your code here
    a
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt= arr-brr     #wrtie your code here
    subt
    subt = np.full_like(arr, 2)
    subt
...
def function11():
    ...
    ans = arr[arr % 2 ==1] = -1          #wrtie your code here
    arr
...
def function12():
    ...
    arr = np.array([1,2,3])
    arr
    ans = np.r_[np.repeat(arr,3), np.tile(arr,3)]    #wrtie your code here
    ans
...
def function13():
    ...
    ans = ((arr>5) & (arr<10))         #wrtie your code here
    arr[ans]
...
def function14():
    ...
    print(arr)
    ans = np.split(arr, 4)          #wrtie your code here
    print(ans)
...
def function15():
    ...
    arr_sort = arr[arr[:,1].argsort()]       #wrtie your code here
    arr_sort  
...
def function16():
    #Write a NumPy program to join a sequence of arrays along depth.
        ...
        x = np.array([[1], [2], [3]])
        y = np.array([[2], [3], [4]])
        ans = np.concatenate((x,y)).reshape((3,1,-1) , order="F")       #wrtie your code here
        print(ans)
...
def function18():
    ...
    x = x = np.count_nonzero(students<101)     # Write you code Here
    x    
    return x
